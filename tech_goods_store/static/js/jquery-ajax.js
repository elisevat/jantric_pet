...
$(document).ready(function () {
    ...
    $(document).on("click", ".add-cart", function (e) {
        ...
        var goodsInCartCount = $(".cart-counter");
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var cartItemsContainer = $(".cart-box");
    ...
    $(document).on("click", ".remove-cart", function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var cartItemsContainer = $(".cart-main-area");
                cartItemsContainer.html(data.cart_main_items_html);
